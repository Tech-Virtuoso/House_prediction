...
from Housing_sales.entity.artifact_entity import ModelPusherArtifact, ModelEvaluationArtifact
from Housing_sales.entity.config_entity import ModelPusherConfig
...
class ModelPusher:
    def __init__(self, model_evaluation_artifact: ModelEvaluationArtifact,
        ...
        self.usvisa_estimator = bankEstimator(bucket_name=model_pusher_config.bucket_name,
